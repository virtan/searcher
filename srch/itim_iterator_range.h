// Copy of Boost.Range with one exception: provides rw-reference access to iterators

#ifndef ITIM_ITERATOR_RANGE_H
#define ITIM_ITERATOR_RANGE_H
...
//  iterator range template class -----------------------------------------//
        ...
        */
        ...
        {
            typedef safe_bool< IteratorT iterator_range<IteratorT>::* > safe_bool_t;
        ...
        public:
            ...
            //! Move constructor from a pair of iterators
            iterator_range( iterator &&Begin, iterator &&End ) :
                m_Begin(std::move(Begin)), m_End(std::move(End))
            {}

            //! Simple copy constructor from a pair of iterators
            ...
            //! Move constructor from a Range
            iterator_range( iterator_range &&r ) :
                m_Begin(std::move(r.m_Begin)), m_End(std::move(r.m_End))
            {}
            ...
            iterator_range& operator=( iterator_range&& r )
            {
                m_Begin  = std::move(r.m_Begin);
            ...
            iterator_range& operator=( ForwardRange&& r )
            {
                m_Begin  = std::move(impl::adl_begin( r ));
                m_End    = std::move(impl::adl_end( r ));
                return *this;
            }
