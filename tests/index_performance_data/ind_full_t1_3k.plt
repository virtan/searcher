...
plot 'ind_1_2_t1_3k_cpp.data' using 1:($2/1000) lt rgb 'dark-green' with dots notitle,\
     'ind_1_2_t1_3k_java.data' using 1:($2/1000) lt rgb 'dark-red' with dots notitle,\
     'ind_3_2_t1_3k_cpp.data' using 1:($2/1000) lt rgb 'green' with dots notitle,\
     'ind_3_2_t1_3k_java.data' using 1:($2/1000) lt rgb 'red' with dots notitle
